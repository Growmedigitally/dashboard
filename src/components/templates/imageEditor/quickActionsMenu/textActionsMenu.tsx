...
import { CUSTOME_ATTRIBUTES, textAttributes } from '@constant/imageEditor';
...
function TextActionsMenu({ updateActiveObjectCords, styles, rerenderCanvas, canvas, activeObjectsState }: pageProps) {
