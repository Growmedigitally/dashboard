...
function Watermark({ canvas, rerenderCanvas, workspace, activeObjectsState }: pageProps) {
    ...
    const onClickType = (type) => {
        ...
        switch (type.id) {
            case WATERMARK_TYPES.LOGO:
                updateLogoWatermark(canvas, rerenderCanvas, watermarkPropsCopy, workspace)
                break;
        ...
        setTimeout(() => rerenderCanvas(canvas), 100);
    }
