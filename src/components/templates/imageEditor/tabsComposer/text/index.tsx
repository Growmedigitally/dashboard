...
const Text = ({ canvas, rerenderCanvas }: any) => {
        ...
        <div>
            <div className={styles.textWrap}>
                ...
                <div className={styles.textPatterns}>
                    ...
                    {canvas?.getActiveObject() && <Patterns activeObject={canvas?.getActiveObject()} canvas={canvas} rerenderCanvas={rerenderCanvas} activeObjectsState={{ eventMode: '', isGroup: false, isMultiple: false, selectedObject: [], isSelected: false }} />}
                </div>
