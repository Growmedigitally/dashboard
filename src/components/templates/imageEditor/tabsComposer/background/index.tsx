...
import { TbSignature, TbGridDots } from 'react-icons/tb';
...
function Background({ canvas, rerenderCanvas, activeObjectsState, workspace }) {
    ...
    const BG_TYPES_LIST = [
        { key: TAB_TYPES.COLOR, icon: <AiOutlineBgColors />, children: <BGColor workspace={workspace} canvas={canvas} /> },
        { key: TAB_TYPES.PATTERN, icon: <TbGridDots />, children: <BGPattern rerenderCanvas={rerenderCanvas} workspace={workspace} canvas={canvas} /> },
        {
            key: TAB_TYPES.IMAGE, icon: <AiFillPicture />, children: <BGImage activeObjectsState={{
                ...
                isSelected: true
            }} rerenderCanvas={rerenderCanvas} activeObject={workspace} canvas={canvas} />
        },
    ]
        ...
        <div className={styles.backgroundWrap}>
            <div className={styles.toggleWrap}>
                <Checkbox
                    ...
                    onChange={(value) => toggleBg(!bgProps.active)}>
                    Show background
                </Checkbox>
            </div>
            {/* <Saperator /> */}
