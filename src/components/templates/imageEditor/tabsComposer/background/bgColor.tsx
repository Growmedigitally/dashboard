...
import { CUSTOME_ATTRIBUTES, OBJECT_TYPES, SOLID_COLORS_LIST } from '@constant/imageEditor'
...
function BGColor({ workspace, canvas }) {
    ...
    return (
        <div className={styles.bgColorWrap}>
            ...
            {activeTab == TAB_TYPES.SOLID ? <>
                ...
                <div className={`${styles.tabContent} ${styles.solidColorWrap}`}>
                    <BGGradient workspace={workspace} canvas={canvas} />
                </div>
            </>}
        </div>
    )
