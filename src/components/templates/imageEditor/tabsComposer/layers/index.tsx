...
import { lockObject, unlockObject } from '@template/imageEditor/objectPropertiesEditor/lock';
...
function Layers({ canvas, rerenderCanvas, activeObjectsState }: pageProps) {
    ...
    const onClickAction = (event: any, action: any, layerId, from, layerIndex, listLength) => {
        ...
        switch (action) {
            case 'UP':
                ...
                // moveLayerUp(canvas, activeObject, rerenderCanvas)
                break;
            case 'DOWN':
                moveObjects(layerId, layerIndex + 1);
                // moveLayerDown(canvas, activeObject, rerenderCanvas)
                break;
            case 'UPTOP':
                moveObjects(layerId, 0);
                // moveLayerUpTop(canvas, activeObject, rerenderCanvas)
                break;
            case 'DOWNTOP':
                moveObjects(layerId, listLength - 1);
                // moveLayerDownTop(canvas, activeObject, rerenderCanvas)
                break;
            case 'LOCK':
