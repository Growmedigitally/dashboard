...
import { letterSpacingList, lineHeightsList, textAttributes } from '@constant/imageEditor';
...
function StylesProps({ rerenderCanvas, canvas, activeObjectsState }: pageProps) {
