...
import { complexImageFilters } from '@constant/imageEditor';
...
function ComplexFilters({ createFilter, rerenderCanvas, canvas, activeObjectsState, getFabricFilterType }: pageProps) {
