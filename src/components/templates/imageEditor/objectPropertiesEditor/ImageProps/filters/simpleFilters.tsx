...
import { simpleImageFilters } from '@constant/imageEditor';
...
function SimpleFilters({ createFilter, rerenderCanvas, canvas, activeObjectsState, getFabricFilterType }: pageProps) {
