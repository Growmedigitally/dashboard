...
import ComplexFilters from '@imageEditor/objectPropertiesEditor/ImageProps/filters/complexFilters';
import SimpleFilters from '@imageEditor/objectPropertiesEditor/ImageProps/filters/simpleFilters';
...
function Filters({ rerenderCanvas, canvas, activeObjectsState }: pageProps) {
        ...
        <div className={styles.filtersWrap}>
            ...
            >
                <Panel header="Filters" key={1} className={styles.panelWrap}>
                    <SimpleFilters getFabricFilterType={getFabricFilterType} createFilter={createFilter} rerenderCanvas={rerenderCanvas} canvas={canvas} activeObjectsState={activeObjectsState} />
                </Panel>
                <Panel header="Adjustments" key={2} className={styles.panelWrap}>
                    <ComplexFilters getFabricFilterType={getFabricFilterType} createFilter={createFilter} rerenderCanvas={rerenderCanvas} canvas={canvas} activeObjectsState={activeObjectsState} />
                </Panel>
            </Collapse>
        </div>
    )
